...
# ----------------------------------------------------------------------------------------------------------------------
def is_equal_triplets(triplet1,triplet2):
    result = False
    if triplet1.alpha1==triplet2.alpha1 and triplet1.alpha2 == triplet2.alpha2 and triplet1.alpha3==triplet2.alpha3 and triplet1.v1 ==triplet2.v1 and triplet1.v2 ==triplet2.v2 and triplet1.v3==triplet2.v3:
        result = True
    return result


def remove_duplicates_from_list(triplets_list_with_duplicates):
    result_list=[]
    result_list.append(triplets_list_with_duplicates[0])
    for triplet1 in triplets_list_with_duplicates:
        for triplet2 in result_list:
            if is_equal_triplets(triplet1,triplet2) == False:
                result_list.append(triplet1)
    return result_list
...
def extract_triplets(c):
    ...
    for i in range(len(c)):
        ...
        find_triplet_neighbours(c, i, R_MIN, R_MAX)
        print('c[i].vn=',c[i].vn)
    ...
    for i in range(len(c)):
        ...
        for j in range(len(c[p1].vn)):
            ...
            for k in range(len(c[p2].vn)):
                ...
                # validate triplet
                if not is_good_triplet(temp, MIN_ANGLE, MAX_ANGLE):
                #if is_good_triplet(temp, 0.2, 3.1)==False:
                #if is_good_triplet(temp, 0.2, 3.1)==False:
                #if is_good_triplet(temp, 0.1, 3.1)==False:#alpha=[20,160]
                    # print('Error!464')
                    # print('temp.alpha1=',temp.alpha1)
                    # print('temp.alpha2=',temp.alpha2)
                    # print('temp.alpha3=',temp.alpha3)
                    # print('~~~~~~~~~~~~~~~~~~')
                    continue
    ...
    #     print(triplet.alpha1)
    #     print(triplet.alpha2)
    #     print(triplet.alpha3)
    #     print(triplet.v1)
    #     print(triplet.v2)
    #     print(triplet.v3)
    #     print('=============')
    ...
    new_triplets=remove_duplicates_from_list(triplets_list_with_duplicates=triplets)

    print(len(new_triplets))
